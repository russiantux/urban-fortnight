...
class CWeaponM4 : public CBaseHL2MPCombatWeapon
{
public:

	DECLARE_CLASS(CWeaponM4, CBaseHL2MPCombatWeapon);
	CWeaponM4(void);
...
{
	{ ACT_MP_STAND_IDLE, ACT_COF_IDLE_M4, false },
	{ ACT_MP_CROUCH_IDLE, ACT_COF_IDLE_CROUCH_M4, false },
	{ ACT_MP_RUN, ACT_COF_RUN_M4, false },
	{ ACT_MP_CROUCHWALK, ACT_COF_WALK_CROUCH_M4, false },
	{ ACT_MP_ATTACK_STAND_PRIMARYFIRE, ACT_COF_GESTURE_RANGE_ATTACK_M4, false },
	{ ACT_MP_ATTACK_CROUCH_PRIMARYFIRE, ACT_COF_GESTURE_RANGE_ATTACK_M4, false },
	{ ACT_MP_RELOAD_STAND, ACT_COF_GESTURE_RELOAD_M4, false },
	{ ACT_MP_RELOAD_CROUCH, ACT_COF_GESTURE_RELOAD_M4, false },
	{ ACT_MP_JUMP, ACT_COF_JUMP_M4, false },
};
...
// Purpose:
//-----------------------------------------------------------------------------
void CWeaponM4::ItemPreFrame(void)
{
	GetStance();
...
// Purpose:
//-----------------------------------------------------------------------------
void CWeaponM4::ItemBusyFrame(void)
{
...
//----------------------------------------------------------------------------- 
bool CWeaponM4::Holster(CBaseCombatWeapon *pSwitchingTo /* = NULL */)
{
	if (m_bInZoom)
	{
		ToggleZoom();
...
//-----------------------------------------------------------------------------
void CWeaponM4::ToggleZoom(void)
{
	CBasePlayer *pPlayer = ToBasePlayer(GetOwner());
...
//-----------------------------------------------------------------------------
void CWeaponM4::CheckZoomToggle(void)
{
	CBasePlayer *pPlayer = ToBasePlayer(GetOwner());
